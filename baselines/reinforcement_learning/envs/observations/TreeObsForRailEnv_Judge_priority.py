...
# from envs.DeadlockChecker import DeadlockChecker
...
class TreeObsForRailEnv(ObservationBuilder):
    ...
    def __init__(self, max_depth: int, predictor: PredictionBuilder = None, judge: Judge = None):
        super().__init__()
    ...
    def reset(self):
        ...
        self.greedy_checker.reset(self.env)
        self.judge.reset(self.env)
    ...
    def get(self, handle: int = 0) -> Node:
        ...
        #14:
            priority of the agent computed with RL agent Judge
    ...
    def _explore_branch(self, handle, position, direction, tot_dist, depth):
        ...
        node = Node(dist_own_target_encountered=own_target_encountered,
                                      ...
                                      time_delay_to_target=agent.get_current_delay(self.env._elapsed_steps, self.env.distance_map),
                                      priority=self.judge.priorities[handle],
                                      childs={})
