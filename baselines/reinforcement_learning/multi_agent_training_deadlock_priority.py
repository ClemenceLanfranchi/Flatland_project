...
from utils.flatland_observation_deadlock_priority import FlatlandObservation, FlatlandTreeObservation , \
...
def train_agent(train_params, train_env_params, eval_env_params, obs_params):
    ...
    for episode_idx in range(n_episodes + 1):
        ...
        if episode_idx % checkpoint_interval == 0 and episode_idx > 0:
            policy.save(train_params.checkpoints_path + '/checkpoints/' + training_id + '-' + str(episode_idx) + '.pth')
